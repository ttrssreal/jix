# https://github.com/cdepillabout/stacklock2nix/blob/3cb77e9/nix/build-support/stacklock2nix/read-yaml.nix

# IFD is the meantime solution 3:
# See: https://github.com/NixOS/nix/issues/4910
